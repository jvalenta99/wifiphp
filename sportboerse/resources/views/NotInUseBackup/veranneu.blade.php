    ...
    <div class="card-body">
      ...
      <form method="post" class = "card-text" action="{{ route('sportveranstaltung.store') }}">
        ...
        <div class="form-group">
          ...
          <input type="number" name="veranMaxstaerke" class="form-control" id="veranMaxteilnehmer"  placeholder="max. Anzahl der Teilnehmer"  value="{{ old('veranMaxTeilnehmer') }}" min="1" max="10">
        </div>
