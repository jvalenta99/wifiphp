...
class Form {
    ...
    /**
     * GUMP filter rules aus Config erstellen
     *
     * @return array
     */
    ...
    /**
     * Fehler für Input Feld über Namen setzen
     *
     * @param string $name
     * @param string $error
     * @return void
     */
    public function setFieldError(string $name, string $error) {
        if (array_key_exists($name, $this->fields)) {
    ...
    /**
     * Den Wert eines Input Feld über den Namen setzen
     *
     * @param string $name
     * @param mixed $value
     * @return void
